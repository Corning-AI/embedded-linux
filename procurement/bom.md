...
| 2 | OV5640 MIPI CSI camera + adapter | MINISASTOCSI   | 1   | NXP official camera module. 5MP, 1080p@30fps. Connects to J12 (CSI1 MIPI) via mini-SAS cable. |
...
| 5 | SSD1306 0.96 inch OLED (I2C, white) | n/a           | 2   | 128x64 white OLED. Shares I2C2 bus with MPU6050.       |
...
| 9  | Micro USB data cable              | n/a          | 1   | For EVK J23 debug serial console (board has built-in FTDI chip).      |
| 10 | USB-C SD/TF card reader           | n/a          | 1   | For flashing Yocto images from PC to SD card.                         |
